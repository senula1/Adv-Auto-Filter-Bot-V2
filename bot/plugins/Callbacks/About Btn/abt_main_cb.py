...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Bot Support:</i></b> <a href="https://t.me/WorldFilmGroupp">@WorldFilmGroupp</a>\n"""
    text+="""\n<b><i>Source Code:</i></b> <a href="https://github.com/senula1/Adv-Auto-Filter-Bot-V2">Source</a>"""

    buttons = [
        [
            InlineKeyboardButton
                (
                    "My Dev ⚡", url="https://t.me/vimuwa123"
                ),
